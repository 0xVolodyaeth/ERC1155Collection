...
import "./LiquidiftyCollectionERC721Master.sol";

contract LiquidiftyCollectionERC721Factory is Ownable {
    address public impl;
    ...
    function cloneCollection(
        ...
        LiquidiftyCollectionERC721Master lcCloned = LiquidiftyCollectionERC721Master(
                cloneAddress
            );
