...
contract LiquidiftyCollectionERC1155Master is
    Ownable,
    GetRoyalties,
    ERC1155,
    ERC1155URIStorage,
    Initializable
{
    ...
    /**
     * @notice constructr is redundant. initialization takes place in initalize function
     */
    constructor() ERC1155("") {}
     ...
     * @param _creator creator of a token. If address(0) is passed then msg.sender will be used
     */
    function mint(
        Fee[] memory _fees,
        uint256 _supply,
